sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.modulePa.controller.SelectDialog1", {
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.modulePa.view.SelectDialog1", this);
			this._bInit = false;
		},
